...
export const P = new ToolbarButton('block', 'P', 'Paragraph', Icons.p, click, { setState })
export const BQ = new ToolbarButton('block', 'BLOCKQUOTE', 'Blockquote', Icons.bq, click, { setState })
export const OL = new ToolbarButton('list', 'OL', 'Ordered list', Icons.ol, click, { setState })
export const UL = new ToolbarButton('list', 'UL', 'Unordered list', Icons.ul, click, { setState })
